...
export default function ViewUserPage() {
    ...
    const onSubmitChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        e.preventDefault();
        try {
      ...
      <h1 className="text-2xl text-center mb-2">Edit Form</h1>
            <form>
                ...
                <div className="mb-3 mt-3">
                    ...
                    value={userField.name} onChange={ changeUserFieldHandler} />
                </div>
                <div className="mb-3 mt-3">
                    ...
                    value={userField.email}  onChange={ changeUserFieldHandler}/>
                </div>
                <div className="mb-3 mt-3">
                     <label className="block text-sm font-medium text-gray-900">Password:</label>
                      ...
                      onChange={ changeUserFieldHandler} required/>
                </div>
                <button type="submit" className="btn btn-success" onClick={e=>onSubmitChange}>Update</button>
            </form>
    </div>
  );
}